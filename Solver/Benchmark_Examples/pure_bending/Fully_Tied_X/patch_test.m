...
restoredefaultpath;
%absolutPath = '/Users/Yingjie/Dropbox/research/interface_problem/code/quad_v5/';
absolutPath = '/Users/wenjiang/Documents/MATLAB/Nitsche_2nd_order/devel/tri_ele/';

addpath(genpath([absolutPath 'Solver/Source/']))
addpath(genpath([absolutPath 'Solver/Benchmark_Examples/pure_bending/Fully_Tied_X/']))
...
PARAMS.Xmin = min(x); PARAMS.Xmax = max(x); PARAMS.xint = 0.4;
PARAMS.Ymin = min(y); PARAMS.Ymax = max(y); PARAMS.yint = 0.4;
...
PARAMS.DB = [1 PARAMS.Xmin;1 PARAMS.Xmax;0 PARAMS.Ymin;0 PARAMS.Ymax]; 
...
PARAMS.plotPath = [absolutPath 'Pre-PostProcessor/Results/pure_bending/Fully_Tied/Fully_Tied_X/'];
